...
export function AppSidebarHeader({
    ...
    return (
        <header 
            className="sticky top-0 z-50 bg-background border-b border-sidebar-border/50 transition-[width,height] ease-linear"
            style={{ 
                paddingTop: "var(--inset-top, env(safe-area-inset-top, 0px))",
                marginTop: "calc(-1 * var(--inset-top, env(safe-area-inset-top, 0px)))"
            }}
        >
            <div className="flex h-16 shrink-0 items-center justify-between gap-2 px-6 group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 md:px-4">
